...
# more orders.hive  
```
>Note: you can get the file contents [here](https://raw.githubusercontent.com/Virtuant/hadoop-overview-spark-hwx/master/temp/orders.hive?token=AAiHOQkIEVig2PTgSfVD3N0hLq0GdAsXks5bz_VWwA%3D%3D).
